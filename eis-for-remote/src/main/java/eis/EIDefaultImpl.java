...
public abstract class EIDefaultImpl implements EnvironmentInterfaceStandard,
	 ...
	 */
	protected LinkedList<String> registeredAgents = null;

	/**
	 * This is a list of entities.
	 */
	protected LinkedList<String> entities = null;

	/**
	 * This map stores the agents-entities-relation.
	 */
	protected ConcurrentHashMap<String, HashSet<String>> agentsToEntities = null;
	 ...
	 */
	protected HashMap<String, String> entitiesToTypes = null;

	/**
	 * The state of the environment-interface
	 */
	protected EnvironmentState state = null;
